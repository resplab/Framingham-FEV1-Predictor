  ...
  sidebarLayout(
    ...
    sidebarPanel(
      tabsetPanel(id = "category",
        ...
        tabPanel(title=paste(emo::ji("smoking"), " ", emo::ji("wine_glass")), value = "panel2", numericInput("daily_cigs","cig. per day", value = NULL, min = 0, step = 1),
        ...
        tabPanel(title=paste(emo::ji("pill"), " ", emo::ji("mask")) , value = "panel3", selectInput("ba_use", "Bronchodilator or aerosol", list('','Current use', 'Former use', 'No use'), selected = ''),
        ...
        tabPanel(title=paste(emo::ji("syringe"), " ", emo::ji("microscope")) , value = "panel4", numericInput("hema","Hematocrit (%)",value = NULL, min = 25, max = 62, step = 1),
